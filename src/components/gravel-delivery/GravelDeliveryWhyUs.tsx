const GravelDeliveryWhyUs = () => {
  return <section id="why-us" className="mem-section bg-white text-mem-darkNavy">
        ...
        <div className="max-w-4xl mx-auto grid md:grid-cols-2 gap-8">
          <div className="bg-gray-100 p-6 rounded-lg">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-xl font-bold text-blue-600">97% on-time arrival</h3>
            </div>
          ...
          <div className="bg-gray-100 p-6 rounded-lg">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-xl font-bold text-blue-600">DOT-compliant fleet</h3>
            </div>
            <p className="text-mem-darkGray">
          ...
          <div className="bg-gray-100 p-6 rounded-lg">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-xl font-bold text-blue-600">Local know-how</h3>
            </div>
            <p className="text-mem-darkGray">
          ...
          <div className="bg-gray-100 p-6 rounded-lg">
            <div className="flex items-center gap-3 mb-4">
              ...
              <h3 className="text-xl font-bold text-blue-600">Industry insight</h3>
            </div>
            <p className="text-mem-darkGray">
...
export default GravelDeliveryWhyUs;